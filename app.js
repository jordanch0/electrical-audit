...
, confirmDeleteArea===area.id
  ?React.createElement('div',{style:{display:"flex",gap:6,alignItems:"center"}}
    ...
    ,React.createElement('button',{style:{...S.smallBtn,color:"#f87171",borderColor:"#ef444466",padding:"7px 12px"},onClick:()=>{delArea(area.id);setConfirmDeleteArea(null);}},"🗑 Delete")
    ,React.createElement('button',{style:{...S.smallBtn,padding:"7px 12px"},onClick:()=>setConfirmDeleteArea(null)},"Keep")
  )
...
, confirmDeletePanel&&confirmDeletePanel.aid===area.id&&confirmDeletePanel.pid===pnl.id
  ?React.createElement('div',{style:{display:"flex",gap:6,alignItems:"center"}}
    ,React.createElement('button',{style:{...S.smallBtn,color:"#f87171",borderColor:"#ef444466"},onClick:()=>{delPanel(area.id,pnl.id);setConfirmDeletePanel(null);}},"Delete")
    ,React.createElement('button',{style:S.smallBtn,onClick:()=>setConfirmDeletePanel(null)},"Keep")
  )
      ...
      React.createElement('div',{key:area.id,style:{border:`1px solid ${expandedArea===area.id?"#a855f755":"#2a2a2a"}`,borderRadius:12,marginBottom:10,overflow:"hidden"}}
        ...
        ,React.createElement('div',{style:{display:"flex",alignItems:"center",gap:8,padding:"10px 14px",background:"#1a1a1a"}}
          ...
          ,confirmDeleteArea===area.id
            ?React.createElement('div',{style:{display:"flex",gap:6,alignItems:"center"}}
              ,React.createElement('span',{style:{fontSize:11,color:"#f87171"}},"Delete?")
              ,React.createElement('button',{style:{...ST.smallBtn,color:"#f87171",borderColor:"#ef444466",padding:"7px 12px"},onClick:()=>{delArea(area.id);setConfirmDeleteArea(null);}},"🗑 Delete")
              ,React.createElement('button',{style:{...ST.smallBtn,padding:"7px 12px"},onClick:()=>setConfirmDeleteArea(null)},"Keep")
            )
