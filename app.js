...
return(React.createElement('div',{style:S.summaryWrap}
  ...
  ,React.createElement('div',{style:{display:"flex",gap:8,flexWrap:"wrap",marginTop:4}}
    ,React.createElement('button',{style:{flex:1,padding:"13px",background:"#1a1200",color:"#e8731a",border:"1px solid #e8731a44",borderRadius:10,fontSize:14,fontWeight:800,cursor:"pointer"},onClick:onExportPush},"📋 Export Push xlsx")
    ,React.createElement('button',{style:{flex:1,padding:"13px",background:"#0a1628",color:"#60a5fa",border:"1px solid #3b82f644",borderRadius:10,fontSize:14,fontWeight:800,cursor:"pointer"},onClick:onExportInject},"🔬 Export Injection xlsx")
  )
));
}
// ─────────────────────────────────────────────────────────────────────────
...
function SWBManageView({project,onUpdateProject}) {
  ...
  return React.createElement('div',{style:SS.listWrap}
    ...
    ,editingProject
      ...
      :React.createElement('button',{style:{...SS.siteCard,marginBottom:16},onClick:()=>{setProjName(project.name);setProjCo(project.company||"");setProjAbn(project.abn||"");setProjLic(project.licence||"");setEditingProject(true);}}
...
function IRTManageView({project,onUpdateProject}){
  ...
  return React.createElement("div",{style:SS.listWrap},
    React.createElement("div",{style:SS.listTitle},"Structure"),
    React.createElement("div",{style:{fontSize:12,color:"#555",marginBottom:16}},"Manage locations, panels and equipment for ",project.name),
