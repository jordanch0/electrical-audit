  ...
  return React.createElement("div",{style:SS.listWrap},
    ...
    projects.map(proj=>{
      ...
      return React.createElement("div",{key:proj.id,style:{...SS.siteCard,flexDirection:"column",gap:0,padding:0,overflow:"hidden"}},
        ...
        deleteId===proj.id?React.createElement("div",{style:{display:"flex",alignItems:"center",gap:8,padding:"8px 18px",background:"#1e1010",borderTop:"1px solid #333"}},React.createElement("span",{style:{fontSize:12,color:"#ef4444",flex:1}},'Delete "',proj.name,'"?'),React.createElement("button",{style:SS.confirmYes,onClick:()=>{onDeleteProject(proj.id);setDeleteId(null);}},"Delete"),React.createElement("button",{style:SS.confirmNo,onClick:()=>setDeleteId(null)},"Cancel"))
        :React.createElement("button",{style:{background:"transparent",border:"none",borderTop:"1px solid #2a2a2a",color:"#555",fontSize:11,padding:"6px 18px",cursor:"pointer",textAlign:"left",width:"100%"},onClick:e=>{e.stopPropagation();setDeleteId(proj.id);}},"\uD83D\uDDD1 Remove site")
      );
    }),
  ...
  return React.createElement("div",{style:{...SS.root,position:"fixed",inset:0}},
    ...
    React.createElement("header",{style:{...SS.topbar,borderBottom:`2px solid ${view==="projects"?"#222":IRT_COLOR+"33"}`}},
      React.createElement("div",{style:SS.topbarLeft},
        ...
        React.createElement("div",null,
          React.createElement("div",{style:SS.appTitle},view==="projects"?"IR TESTING":project?.name||"IR TESTING"),
          React.createElement("div",{style:{...SS.appSub,color:view==="projects"?"#555":IRT_COLOR}},view==="projects"?"Insulation Resistance":view==="home"?"Site Overview":view==="audit"?"Select Location":view==="area"&&area?area.name:view==="panel"&&panel?panel.name:view==="item"&&activeItemName?activeItemName:view==="report"?"Report":view==="manage"?"Structure":view==="history"?"History":view==="dropdowns"?"Dropdowns":"Insulation Resistance")
        )
      ),
      React.createElement("div",{style:SS.topbarRight},
        React.createElement("span",{style:{fontSize:11,color:"#22c55e",fontWeight:600,opacity:saveFlash?1:0,transition:"opacity 0.4s",pointerEvents:"none"}},"\u2713 Saved"),
