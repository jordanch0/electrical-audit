...
, deleteId&&React.createElement('div',{style:{position:"fixed",inset:0,zIndex:5},onClick:()=>setDeleteId(null)})
, projects.map(proj=>{
...
, deleteId===proj.id
?React.createElement('div', { style: {display:"flex",alignItems:"center",gap:8,padding:"8px 18px",background:"#1e1010",borderTop:"1px solid #333",position:"relative",zIndex:6},}
...
function ThermoProjectListView({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    deleteId && /*#__PURE__*/React.createElement("div", {style:{position:"fixed",inset:0,zIndex:5},onClick:()=>setDeleteId(null)}),
    projects.map(proj => {
  ...
  return React.createElement("div",{style:SS.listWrap},
    ...
    projects.map(proj=>{
      ...
      return React.createElement("div",{key:proj.id,style:{...SS.siteCard,flexDirection:"column",gap:0,padding:0,overflow:"hidden"}},
        ...
        deleteId===proj.id?React.createElement("div",{style:{display:"flex",alignItems:"center",gap:8,padding:"8px 18px",background:"#1e1010",borderTop:"1px solid #333",position:"relative",zIndex:6}},React.createElement("span",{style:{fontSize:12,color:"#ef4444",flex:1}},'Delete "',proj.name,'"?'),React.createElement("button",{style:SS.confirmYes,onClick:()=>{onDeleteProject(proj.id);setDeleteId(null);}},"Delete"),React.createElement("button",{style:SS.confirmNo,onClick:()=>setDeleteId(null)},"Cancel"))
        :React.createElement("button",{style:{background:"transparent",border:"none",borderTop:"1px solid #2a2a2a",color:"#555",fontSize:11,padding:"6px 18px",cursor:"pointer",textAlign:"left",width:"100%"},onClick:e=>{e.stopPropagation();setDeleteId(proj.id);}},"\uD83D\uDDD1 Remove site")
      );
    }),
