...
, React.createElement('button', { style: S.confirmYes, onClick: e=>{e.stopPropagation();onDeleteProject(proj.id);setDeleteId(null);},}, "Delete")
, React.createElement('button', { style: S.confirmNo,  onClick: e=>{e.stopPropagation();setDeleteId(null);},}, "Cancel")
)
...
, React.createElement('button', { style: {flex:1,display:"flex",alignItems:"center",gap:8,background:"transparent",border:"none",cursor:"pointer",color:"inherit",textAlign:"left",padding:0}, onClick: ()=>{const closing=expandedPanel===pnl.id;setExpandedPanel(closing?null:pnl.id);setEditingCircuit(null);setConfirmDeleteCircuit(null);setConfirmDeletePanel(null);},}
...
, confirmDeletePanel&&confirmDeletePanel.aid===area.id&&confirmDeletePanel.pid===pnl.id
  ?React.createElement('div',{style:{display:"flex",gap:6,alignItems:"center"}}
    ,React.createElement('button',{style:{...S.smallBtn,color:"#f87171",borderColor:"#ef444466"},onClick:e=>{e.stopPropagation();delPanel(area.id,pnl.id);setConfirmDeletePanel(null);}},"Delete")
    ,React.createElement('button',{style:S.smallBtn,onClick:e=>{e.stopPropagation();setConfirmDeletePanel(null);}},"Keep")
  )
...
, pnl.circuits.map(c=>{
  ...
  return(React.createElement('div',{key:c,style:{background:"#1e1e1e",border:"1px solid #333",borderRadius:8,padding:"6px 8px",display:"flex",alignItems:"center",gap:6}},
    ...
    React.createElement('button',{style:{background:"#2a1010",border:"1px solid #ef444433",color:"#ef4444",cursor:"pointer",fontSize:13,padding:"4px 9px",borderRadius:6,flexShrink:0},onClick:e=>{e.stopPropagation();setEditingCircuit(null);setConfirmDeletePanel(null);setConfirmDeleteCircuit({aid:area.id,pid:pnl.id,circuit:c});}},"✕")
  ));
})
      ...
      React.createElement('div',{key:area.id,style:{border:`1px solid ${expandedArea===area.id?"#a855f755":"#2a2a2a"}`,borderRadius:12,marginBottom:10,overflow:"hidden"}}
        ,React.createElement('div',{style:{display:"flex",alignItems:"center",gap:8,padding:"12px 14px",background:"#1a1a1a"}}
          ...
          ,confirmDeleteArea===area.id
            ?React.createElement('div',{style:{display:"flex",gap:6,alignItems:"center"}}
              ,React.createElement('span',{style:{fontSize:11,color:"#f87171"}},"Delete?")
              ,React.createElement('button',{style:{...SI.smallBtn,color:"#f87171",borderColor:"#ef444466",padding:"7px 12px"},onClick:e=>{e.stopPropagation();delArea(area.id);setConfirmDeleteArea(null);}},"🗑 Delete")
              ,React.createElement('button',{style:{...SI.smallBtn,padding:"7px 12px"},onClick:e=>{e.stopPropagation();setConfirmDeleteArea(null);}},"Keep")
            )
            :React.createElement('button',{style:{...SI.smallBtn,color:"#ef4444",borderColor:"#ef444433"},onClick:e=>{e.stopPropagation();setConfirmDeleteArea(area.id);setExpandedArea(null);setConfirmDeleteItem(null);}},"🗑")
        )
                ...
                ,(area.panels.find(p=>p.name===cat.key)||{circuits:[],machineNames:{}}).circuits.map(itemId=>{
                  ...
                  if(isConfirming){
                    return React.createElement('div',{key:itemId,style:{background:"#2a1010",border:"1px solid #ef444466",borderRadius:8,padding:"8px 10px",display:"flex",flexDirection:"column",gap:6,width:"100%",boxSizing:"border-box"}}
                      ...
                      ,React.createElement('div',{style:{display:"flex",gap:6}}
                        ,React.createElement('button',{style:{...SI.smallBtn,flex:1,color:"#f87171",borderColor:"#ef444466",fontSize:13,padding:"8px 0"},onClick:e=>{e.stopPropagation();delItem(area.id,cat.key,itemId);setConfirmDeleteItem(null);}},"✕ Delete")
                        ,React.createElement('button',{style:{...SI.smallBtn,flex:1,fontSize:13,padding:"8px 0"},onClick:e=>{e.stopPropagation();setConfirmDeleteItem(null);}},"Keep")
                      )
                    );
                  }
                  return React.createElement('div',{key:itemId,style:{display:"flex",alignItems:"center",gap:6,background:"#1e1e1e",border:`1px solid ${cat.color}33`,borderRadius:8,padding:"6px 10px"}}
                    ...
                    ,React.createElement('button',{style:{background:"#2a1010",border:"1px solid #ef444433",color:"#ef4444",cursor:"pointer",fontSize:13,padding:"4px 9px",borderRadius:6,flexShrink:0},onClick:e=>{e.stopPropagation();setConfirmDeleteItem({aid:area.id,catKey:cat.key,itemId});}},"✕")
                  );
                })
            ...
            ,(area.items||[]).map(itemId=>{
              ...
              if(isConfirming){
                return React.createElement('div',{key:itemId,style:{background:"#2a1010",border:"1px solid #ef444466",borderRadius:8,padding:"8px 10px",display:"flex",flexDirection:"column",gap:6,width:"100%",boxSizing:"border-box"}}
                  ...
                  ,React.createElement('div',{style:{display:"flex",gap:6}}
                    ,React.createElement('button',{style:{...ST.smallBtn,flex:1,color:"#f87171",borderColor:"#ef444466",fontSize:13,padding:"8px 0"},onClick:e=>{e.stopPropagation();delItem(area.id,itemId);setConfirmDeleteItem(null);}},"✕ Delete")
                    ,React.createElement('button',{style:{...ST.smallBtn,flex:1,fontSize:13,padding:"8px 0"},onClick:e=>{e.stopPropagation();setConfirmDeleteItem(null);}},"Keep")
                  )
                );
              }
              ...
              return React.createElement('div',{key:itemId,style:{display:"flex",alignItems:"center",gap:6,background:"#1e1e1e",border:`1px solid ${TAT_COLOR}33`,borderRadius:8,padding:"6px 10px"}}
                ...
                ,React.createElement('button',{style:{background:"#2a1010",border:"1px solid #ef444433",color:"#ef4444",cursor:"pointer",fontSize:13,padding:"4px 9px",borderRadius:6,flexShrink:0},onClick:e=>{e.stopPropagation();setEditingItem(null);setConfirmDeleteItem({areaId:area.id,itemId});}},"✕")
              );
            })
...
function ThermoManageView({
  ...
  project.areas.map(area => /*#__PURE__*/React.createElement("div", {
    ...
    onClick: () => { setExpandedBoard(expandedBoard === board.id ? null : board.id); setConfirmDeleteCircuit(null); setConfirmDeleteBoard(null); }
  }, /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: 14,
          ...
          :React.createElement(React.Fragment,null
            ...
            ,React.createElement('div',{style:{display:"flex",gap:6,alignItems:"center"}}
              ...
              ,confirmDelArea===area.id
                ?React.createElement('div',{style:{display:"flex",gap:6,alignItems:"center"}}
                  ,React.createElement('span',{style:{fontSize:11,color:"#f87171"}},"Delete?")
                  ,React.createElement('button',{style:{...SS.smallBtn,flex:1,color:"#f87171",borderColor:"#ef444466",fontSize:13,padding:"10px 0"},onClick:e=>{e.stopPropagation();delArea(area.id);setConfirmDelArea(null);}},"🗑 Delete")
                  ,React.createElement('button',{style:{...SS.smallBtn,flex:1,fontSize:13,padding:"10px 0"},onClick:e=>{e.stopPropagation();setConfirmDelArea(null);}},"Keep")
                )
          ...
          ,editingBoard&&editingBoard.aid===area.id&&editingBoard.bid===b.id
            ...
            :confirmDelBoard&&confirmDelBoard.aid===area.id&&confirmDelBoard.bid===b.id
              ?React.createElement('div',{style:{display:"flex",alignItems:"center",gap:8,padding:"8px 10px",background:"#1e1010",border:"1px solid #ef444433",borderRadius:8}}
                ...
                ,React.createElement('button',{style:{...SS.smallBtn,flex:1,color:"#f87171",borderColor:"#ef444466",fontSize:13,padding:"10px 0"},onClick:e=>{e.stopPropagation();delBoard(area.id,b.id);setConfirmDelBoard(null);}},"🗑 Delete")
                ,React.createElement('button',{style:{...SS.smallBtn,flex:1,fontSize:13,padding:"10px 0"},onClick:e=>{e.stopPropagation();setConfirmDelBoard(null);}},"Keep")
              )
  ...
  return React.createElement("div",{style:SS.listWrap},
    ...
    projects.map(proj=>{
      ...
      return React.createElement("div",{key:proj.id,style:{...SS.siteCard,flexDirection:"column",gap:0,padding:0,overflow:"hidden"}},
        ...
        deleteId===proj.id?React.createElement("div",{style:{display:"flex",alignItems:"center",gap:8,padding:"8px 18px",background:"#1e1010",borderTop:"1px solid #333"}},React.createElement("span",{style:{fontSize:12,color:"#ef4444",flex:1}},'Delete "',proj.name,'"?'),React.createElement("button",{style:SS.confirmYes,onClick:e=>{e.stopPropagation();onDeleteProject(proj.id);setDeleteId(null);}},"Delete"),React.createElement("button",{style:SS.confirmNo,onClick:e=>{e.stopPropagation();setDeleteId(null);}},"Cancel"))
        :React.createElement("button",{style:{background:"transparent",border:"none",borderTop:"1px solid #2a2a2a",color:"#555",fontSize:11,padding:"6px 18px",cursor:"pointer",textAlign:"left",width:"100%"},onClick:e=>{e.stopPropagation();setDeleteId(proj.id);}},"\uD83D\uDDD1 Remove site")
      );
    }),
  ...
  return React.createElement("div",{style:SS.listWrap},
    ...
    (project.areas||[]).map(area=>React.createElement("div",{key:area.id,style:{background:"#161616",border:`1px solid ${expandedArea===area.id?IRT_COLOR+"55":"#2a2a2a"}`,borderRadius:12,marginBottom:10,overflow:"hidden"}},
      React.createElement("div",{style:{display:"flex",alignItems:"center",justifyContent:"space-between",padding:"12px 14px"}},
        ...
        React.createElement("div",{style:{display:"flex",gap:6,alignItems:"center"}},
          confirmDelArea===area.id?React.createElement("div",{style:{display:"flex",gap:6,alignItems:"center"}},React.createElement("span",{style:{fontSize:11,color:"#f87171"}},"Delete?"),React.createElement("button",{style:{...SS.smallBtn,color:"#f87171",borderColor:"#ef444466",padding:"7px 12px"},onClick:e=>{e.stopPropagation();delArea(area.id);setConfirmDelArea(null);}},"\uD83D\uDDD1 Delete"),React.createElement("button",{style:{...SS.smallBtn,padding:"7px 12px"},onClick:e=>{e.stopPropagation();setConfirmDelArea(null);}},"Keep")):React.createElement("button",{style:{...SS.smallBtn,color:"#ef4444",borderColor:"#ef444433"},onClick:e=>{e.stopPropagation();setConfirmDelArea(area.id);setConfirmDelPanel(null);}},"\uD83D\uDDD1"),
          React.createElement("span",{style:{fontSize:16,color:"#555",cursor:"pointer"},onClick:()=>setExpandedArea(expandedArea===area.id?null:area.id)},expandedArea===area.id?"\u25b2":"\u25bc")
        )
      ),
      expandedArea===area.id&&React.createElement("div",{style:{padding:"0 14px 14px"}},
        (area.panels||[]).map(panel=>React.createElement("div",{key:panel.id,style:{border:`1px solid ${expandedPanel===panel.id?IRT_COLOR+"44":"#222"}`,borderRadius:8,marginBottom:8,background:"#111"}},
          React.createElement("div",{style:{display:"flex",alignItems:"center",gap:8,padding:"10px 12px"}},
            ...
            confirmDelPanel===panel.id?React.createElement("div",{style:{display:"flex",gap:6}},React.createElement("button",{style:{...SS.smallBtn,color:"#f87171",borderColor:"#ef444466"},onClick:e=>{e.stopPropagation();delPanel(area.id,panel.id);setConfirmDelPanel(null);}},"Delete"),React.createElement("button",{style:SS.smallBtn,onClick:e=>{e.stopPropagation();setConfirmDelPanel(null);}},"Keep")):React.createElement("button",{style:{...SS.smallBtn,color:"#ef4444",borderColor:"#ef444433",fontSize:11},onClick:e=>{e.stopPropagation();setConfirmDelPanel(panel.id);setConfirmDelArea(null);}},"\uD83D\uDDD1")
          ),
