        ...
        ,editingAreaId===area.id
          ...
          :React.createElement(React.Fragment,null
            ...
            ,React.createElement('div',{style:{display:"flex",gap:6,alignItems:"center"}}
              ...
              ,React.createElement('span',{style:{fontSize:16,color:"#555",cursor:"pointer"},onClick:()=>{setExpandedArea(expandedArea===area.id?null:area.id);setConfirmDelArea(null);setConfirmDelBoard(null);}},expandedArea===area.id?"▲":"▼")
            )
          )
      )
...
function IRTManageView({project,onUpdateProject}){
  ...
  React.useEffect(()=>{
    const dismiss=()=>{setConfirmDelArea(null);setConfirmDelPanel(null);};
    document.addEventListener('click',dismiss);
    return()=>document.removeEventListener('click',dismiss);
  },[]);
  return React.createElement("div",{style:SS.listWrap},
