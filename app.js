...
const load = async (key, fallback) => { try { const r=await window.storage.get(key); return r?JSON.parse(r.value):fallback; } catch(_) { return fallback; } };
const save = async (key, val) => { try { await window.storage.set(key, JSON.stringify(val)); } catch(_) {} };
// ─────────────────────────────────────────────────────────────────────────
// DATA HELPERS
// ─────────────────────────────────────────────────────────────────────────
...
// ═════════════════════════════════════════════════════════════════════════
function App() {
const [projects,      setProjects]     = React.useState.call(void 0, []);
const [allResults,    setAllResults]   = React.useState.call(void 0, {});
const [allMeta,       setAllMeta]      = React.useState.call(void 0, {});
const [history,       setHistory]      = React.useState.call(void 0, []);
const [dropdowns,     setDropdowns]    = React.useState.call(void 0, { responsibility:DEFAULT_RESPONSIBILITY, rectified:DEFAULT_RECTIFIED });
const [logo,          setLogo]         = React.useState.call(void 0, null);  // base64 data-URL
const [activeProject, setActiveProject]= React.useState.call(void 0, null);
const [mode,          setMode]         = React.useState.call(void 0, null);
const [view,          setView]         = React.useState.call(void 0, "projects");
const [activeAreaId,  setActiveAreaId] = React.useState.call(void 0, null);
const [activePanelId, setActivePanelId]= React.useState.call(void 0, null);
const [loaded,        setLoaded]       = React.useState.call(void 0, false);
const [saveFlash,     setSaveFlash]    = React.useState.call(void 0, false);
const [detailInfo,    setDetailInfo]   = React.useState.call(void 0, null);
...
React.useEffect.call(void 0, ()=>{ if(loaded){save(K_PROJECTS,projects);} },[projects,loaded]);
React.useEffect.call(void 0, ()=>{ if(loaded){save(K_RESULTS,allResults);setSaveFlash(true);const t=setTimeout(()=>setSaveFlash(false),1200);return()=>clearTimeout(t);} },[allResults,loaded]);
React.useEffect.call(void 0, ()=>{ if(loaded){save(K_META,allMeta);} },[allMeta,loaded]);
React.useEffect.call(void 0, ()=>{ if(loaded){save(K_HISTORY,history);} },[history,loaded]);
React.useEffect.call(void 0, ()=>{ if(loaded){save(K_DROPDOWNS,dropdowns);} },[dropdowns,loaded]);
React.useEffect.call(void 0, ()=>{ if(loaded){save(K_LOGO,logo);} },[logo,loaded]);
...
const [showAdd,    setShowAdd]    = React.useState.call(void 0, false);
const [tab,        setTab]        = React.useState.call(void 0, "manual"); // manual | import
const [newName,    setNewName]    = React.useState.call(void 0, "");
const [newCo,      setNewCo]      = React.useState.call(void 0, "Vorick Group");
const [newAbn,     setNewAbn]     = React.useState.call(void 0, "44 601 045 872");
const [newLic,     setNewLic]     = React.useState.call(void 0, "319114C");
const [deleteId,   setDeleteId]   = React.useState.call(void 0, null);
const [importing,  setImporting]  = React.useState.call(void 0, false);
const [importPreview, setImportPreview] = React.useState.call(void 0, null); // parsed project before confirming
const [importName, setImportName] = React.useState.call(void 0, "");
const [importCo,   setImportCo]   = React.useState.call(void 0, "Vorick Group");
const [importAbn,  setImportAbn]  = React.useState.call(void 0, "44 601 045 872");
const [importLic,  setImportLic]  = React.useState.call(void 0, "319114C");
const [importError,setImportError]= React.useState.call(void 0, "");
const fileRef = React.useRef.call(void 0, );
const handleFile = e => {
...
const [showExports,setShowExports]=React.useState.call(void 0, false);
const [confirmReset,setConfirmReset]=React.useState.call(void 0, false);
const [archiveMsg,setArchiveMsg]=React.useState.call(void 0, "");
...
const [expanded,   setExpanded]  = React.useState.call(void 0, null);
const [deleteId,   setDeleteId]  = React.useState.call(void 0, null);
const [viewSnap,   setViewSnap]  = React.useState.call(void 0, null);  // snap being viewed in full
const [viewArea,   setViewArea]  = React.useState.call(void 0, null);  // area id in snapshot viewer
...
const [newVals, setNewVals] = React.useState.call(void 0, {});
const logoRef = React.useRef.call(void 0, );
...
const [open, setOpen] = React.useState.call(void 0, false);
const [custom, setCustom] = React.useState.call(void 0, false);
const [typedVal, setTypedVal] = React.useState.call(void 0, value||"");
const isCustom = value && !options.includes(value);
React.useEffect.call(void 0, ()=>{ if(isCustom){setCustom(true);setTypedVal(value);} },[]);
if(custom){
return (
React.createElement('div', { style: {display:"flex",gap:8},}
...
const [expandedArea,setExpandedArea]=React.useState.call(void 0, null);
const [expandedPanel,setExpandedPanel]=React.useState.call(void 0, null);
const [newAreaName,setNewAreaName]=React.useState.call(void 0, "");
const [newPanelName,setNewPanelName]=React.useState.call(void 0, {});
const [newCircuit,setNewCircuit]=React.useState.call(void 0, {});
const [bulkCircuit,setBulkCircuit]=React.useState.call(void 0, {});
const [editingProject,setEditingProject]=React.useState.call(void 0, false);
const [projName,setProjName]=React.useState.call(void 0, project.name);
const [projCo,setProjCo]=React.useState.call(void 0, project.company||"");
const [projAbn,setProjAbn]=React.useState.call(void 0, project.abn||"");
const [projLic,setProjLic]=React.useState.call(void 0, project.licence||"");
...
const [consolidateMsg, setConsolidateMsg] = React.useState.call(void 0, "");
return (
React.createElement('div', { style: S.listWrap,}
...
(function(){var root=ReactDOM.createRoot(document.getElementById("root"));root.render(React.createElement(App));if(window.__hideLoading)window.__hideLoading();})();