...
function SWBApp({ onGoHome }) {
  ...
  return React.createElement('div',{style:SS.root}
    ...
    ,view!=="projects"&&React.createElement('nav',{style:SS.bottomNav}
      ...
      ,React.createElement(SWBNavBtn,{icon:"☑",label:"Audit",  active:["audit","area","board","item"].includes(view),onClick:()=>{if(auditEntered){setActiveAreaId(null);setActiveBoardId(null);setView("audit");}else{goHome();}}, color:"#a855f7"})
