...
, React.createElement('div', { style: S.brandBlock,}, React.createElement('div', { style: S.brandTitle,}, project.company||"SPARKCHECK"), React.createElement('div', { style: S.brandSub,}, "Electrical Audit Software" ))
...
function IELProjectHomeView({project,meta,setMeta,results,onStartCat,onReport,onManage,onHistory,onReset,onExport,onArchive,onCompleteAudit,activeCatKey}){
  ...
  return React.createElement('div',{style:SI.homeWrap}
    ,React.createElement('div',{style:SI.brandBlock}
      ,React.createElement('div',{style:SI.brandTitle},"SPARKCHECK")
      ,React.createElement('div',{style:SI.brandSub},"Electrical Audit Software")
    )
...
function irtStyles(){
  return{
    ...
    topbar:{display:"flex",justifyContent:"space-between",alignItems:"center",padding:"0 16px",height:52,flexShrink:0,background:"#111",borderBottom:"2px solid #3b82f633",zIndex:10},
...
function IRTItemPage({itemId,itemName,panel,area,project,results,dropdowns,warnDismissed,onDismissWarn,onPatch,onBack}){
  ...
  return React.createElement("div",{style:{padding:"16px 16px 40px"}},
    ...
    isFail&&React.createElement("div",{style:{background:"#1e0a0a",border:"1px solid #ef444433",borderRadius:10,padding:"12px",marginBottom:4}},
      ...
      React.createElement("div",{style:{display:"flex",gap:10}},
        React.createElement("div",{style:{...SS.modalField,flex:1}},React.createElement("label",{style:SS.modalLabel},"DATE RECTIFIED"),React.createElement("input",{style:SS.modalInput,type:"date",value:form.scheduledDate||"",onChange:e=>pf({scheduledDate:e.target.value})})),
        React.createElement("div",{style:{...SS.modalField,flex:1}},React.createElement("label",{style:SS.modalLabel},"DEFECT ID"),React.createElement("input",{style:SS.modalInput,type:"text",placeholder:"e.g. 61",value:form.defectId||"",onChange:e=>pf({defectId:e.target.value})}))
      ),
...
function IRTReportView({project,results,meta,onExport,onArchive}){
  ...
  return React.createElement("div",{style:SS.summaryWrap},
    React.createElement("div",{style:{...SS.summaryTitle,color:IRT_COLOR}},project.name),
