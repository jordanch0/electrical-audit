...
function ThermoManageView({
  ...
  project.areas.map(area => /*#__PURE__*/React.createElement("div", {
    ...
    onClick: e => { e.stopPropagation(); setConfirmDeleteArea(area.id); }
    ...
    onClick: e => { e.stopPropagation(); setConfirmDeleteBoard(board.id); }
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      onClick: e => { e.stopPropagation(); setConfirmDeleteCircuit({areaId: area.id, boardId: board.id, cid, name: cName}); }
    }, "\u2715"));
          ...
          :React.createElement(React.Fragment,null
            ...
            ,React.createElement('div',{style:{display:"flex",gap:6,alignItems:"center"}}
              ...
              ,confirmDelArea===area.id
                ...
                :React.createElement('button',{style:{...SS.smallBtn,color:"#ef4444",borderColor:"#ef444433"},onClick:e=>{e.stopPropagation();setConfirmDelArea(area.id);}},"🗑")
          ...
          ,editingBoard&&editingBoard.aid===area.id&&editingBoard.bid===b.id
            ...
            :confirmDelBoard&&confirmDelBoard.aid===area.id&&confirmDelBoard.bid===b.id
              ...
              :React.createElement('div',{style:{display:"flex",alignItems:"center",gap:8,padding:"8px 10px",background:"#111",borderRadius:8}}
                ...
                ,React.createElement('button',{style:{...SS.smallBtn,color:"#ef4444",borderColor:"#ef444433"},onClick:e=>{e.stopPropagation();setConfirmDelBoard({aid:area.id,bid:b.id});setEditingBoard(null);}},"🗑")
              )
        ))
