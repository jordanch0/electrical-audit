...
, React.createElement('div', { style: {display:"flex",gap:10,overflow:"hidden"},}
...
return (
React.createElement('div', { style: S.listWrap, onClick: ()=>{ setConfirmDeleteArea(null);setConfirmDeletePanel(null);setConfirmDeleteCircuit(null); },}
...
function ThermoProjectListView({
  ...
  return /*#__PURE__*/React.createElement("div", {
    style: STH.listWrap,
    onClick: () => { if(deleteId) setDeleteId(null); }
  }, /*#__PURE__*/React.createElement("div", {
    style: {
      ...STH.brandBlock,
